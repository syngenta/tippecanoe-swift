...
sed -i ".bak" "s/s.version          = .*/s.version          = '"$version"'/" tippecanoe-swift.podspec
...
pod repo push cropio-specs tippecanoe-swift.podspec --allow-warnings

# Back to primary
git checkout tippecanoe-swift.podspec
